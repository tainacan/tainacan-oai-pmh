				...
				<div>
					<strong>
						...
						if ( $index_health['status'] === 'healthy' ) {
							esc_html_e( 'Healthy', 'tainacan-oai-pmh' );
						} elseif ( $index_health['status'] === 'warning' ) {
							esc_html_e( 'Needs Attention', 'tainacan-oai-pmh' );
						} else {
							esc_html_e( 'Needs Reindex', 'tainacan-oai-pmh' );
						}
						?>
					</strong>
					<p>
